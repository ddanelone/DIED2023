...
public class ArbolBinarioBusqueda<E extends Comparable<E>> extends Arbol<E> {
	...
	public boolean esHoja() {
		...
		return (izquierdo.esVacio() && derecho.esVacio()) ? true : false;
	...
	public int cantidadNodos() {
		if (this.esVacio()) return 0;  
			...
			return 1 + (this.izquierdo.cantidadNodos() + this.derecho.cantidadNodos());
		}
	}
	...
	public boolean esZurdo() {
		if (this.esVacio() || this.esHoja()) return true; 

		if (izquierdo.cantidadNodos() > this.cantidadNodos()) {
