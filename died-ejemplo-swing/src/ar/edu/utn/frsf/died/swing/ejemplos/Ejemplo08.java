...
public class Ejemplo08 {
	...
	public static void main(String[] args) {
		...
		JButton boton1 = new JButton("L&F 1");
		gbc.gridx=0;
		gbc.gridy=2;
		gbc.gridwidth=1;	
		gbc.weightx=0.0;
		...
		JButton boton2 = new JButton("L&F 2");
		gbc.gridx=1;
		layoutMgr.setConstraints(boton2, gbc);

		JButton boton3 = new JButton("L&F 3");
		gbc.gridx=2;
		layoutMgr.setConstraints(boton3, gbc);
