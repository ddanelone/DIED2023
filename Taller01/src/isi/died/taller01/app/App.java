...
public class App {
	...
	/**
	 * a. Crear un alumno, un curso obligatorio e inscribir a dicho alumno al curso
	 * obligatorio (puede crear todos los objetos auxiliares que necesite) de manera
	 * exitosa.
	 */
	...
	/**
	 * b. Crear un alumno, un curso optativo e inscribir a dicho alumno al curso
	 * optativo (puede crear todos los objetos auxiliares que necesite).
	 */
	...
	/**
	 * c. Crear un alumno que no cumple los requisitos para anotarse a un curso
	 * obligatorio, intentar inscribir a dicho alumno al curso obligatorio (puede
	...
	/**
	 * d. Crear un alumno que no cumple los requisitos para anotarse a un curso
	 * opcional, intentar inscribir a dicho alumno al curso opcional (puede crear
	 * todos los objetos auxiliares que necesite).
	 */
	...
	/**
	 * f. Crear un docente que ya este asignado a 3 cursos y asignarlo a un cuarto
	 * curso para lanzar una excepci�n y capturarla en el m�todo main.
	 */
